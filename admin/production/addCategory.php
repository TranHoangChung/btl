    ...
    <div class="container body">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <a class="btn btn-primary" href="Category.php" role="button">Trở Về</a>
          ...
          if(isset($_POST['submit'])){
            $categoryId = $addRepository->insert($_POST['name']);
            echo "<script>alert('Thêm thành công');window.location.href='Category.php';</script>";
          }
        ?>
                </form>
            </div>
